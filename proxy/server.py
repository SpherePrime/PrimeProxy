...
def main():
    ...
    if args.secret:
        ...
        log.error("No secret: pass --secret <32 hex chars>. "
                  "The app/CLI reads the stored secret from the config "
                  "(set it once in Settings); the server no longer generates one.")
        sys.exit(1)
