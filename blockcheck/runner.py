...
class BlockcheckRunner:
    """Orchestrates all blockcheck tests. Sync — call from worker thread."""
    ...
    def __init__(
        ...
        # Готовые цели извне (одиночная проверка через страницу «Проверка
        # сайтов»): сборка списка и поиск GoogleVideo CDN при них не нужны.
