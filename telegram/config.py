...
from telegram.upstream_catalog import UpstreamCatalog, UpstreamPresetResolver
from telegram.cloudflare import AUTO_CLOUDFLARE_DOMAINS, CloudflareFallbackConfig, normalize_domain_list
from telegram.dc_map import parse_dc_endpoint_overrides
from telegram.fake_tls import normalize_fake_tls_domain
from telegram.mtproxy import build_mtproxy_link, generate_secret, normalize_secret
...
def build_upstream_config():
    try:
        from telegram.routing import UpstreamProxyConfig, UpstreamProxyEndpoint
        from settings.store import (
            get_tg_proxy_mode,
            get_tg_proxy_upstream_enabled,
            get_tg_proxy_upstream_host,
